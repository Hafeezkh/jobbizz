          ...
          <div className="grid grid-cols-1 items-center gap-4  md:grid-cols-2">
            ...
            >
              <h1 className="text-2xl md:text-4xl ">
                Welcome to  <a href="/#home" className="">
               SYS
...
Discover the Pinnacle of Banking Excellence in Your Town: Unmatched Service, Smart Solutions, and Your Financial Partner of Choice
              </p>
              <div>
                <ul className="flex list-inside list-disc flex-col gap-2  md:gap-4">
                  ...
                  <li className="font-medium">
                  Smart Solutions, Secure Banking.
                  </li>
                  <li className="font-medium">Transform Your Finances, Command Success with SysBank.</li>
                </ul>
              </div>
